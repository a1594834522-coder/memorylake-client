...
from memorylake_sdk import BaseMemoryBackend
from memorylake_sdk.exceptions import MemoryBackendError, MemoryFileOperationError, MemoryPathError
...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    if args.with_client:
        from memorylake_sdk import MemoryLakeClient
